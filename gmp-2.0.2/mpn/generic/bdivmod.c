...
{
#ifdef REENTRANT_GMP
  /* If we want reentrant_gmp we dont want to have any static data in
     gmp-library, disable v_inv caching //kivinen 23:11 Aug  1 1996 */
  mp_limb_t v_inv;
#else
  ...
  if (vp[0] != previous_low_vlimb)	/* Cache miss; compute v_inv.  */
#endif
    {
      ...
      mp_limb_t two_i = 1;
#ifndef REENTRANT_GMP
      previous_low_vlimb = v;
#endif
      v_inv = 0;
      do
	{
